"""Explanation
Preprocess Text: The preprocess_text function is used to clean the text.
Tokenize and Clean Sentences: The tokenize_and_clean function tokenizes and cleans each sentence.
Split into Sentences: The sent_tokenize function splits the text into sentences.
Create Bigrams: Bigrams are created for sentences.
Create Dictionary and Corpus: A dictionary and corpus are created based on sentences.
Apply LDA: LDA is applied to the corpus with the specified number of topics.
This approach will allow you to perform LDA based on sentences instead of individual words."""
...
for repo_id, repo in data.items():
    ...
    if combined_instructions:
        sentences = sent_tokenize(combined_instructions.strip())  # Split into sentences
...
output_file = 'lda-sentences.html'
