...
# Example usage
extracted_metadata_folder = 'extractor/01.1-extracted_metadata-c' #folder with JSON files containing metadata
output_json_file = 'extractor/02_installation_readmes-c.json' #input file for computing clustering
